...
scenario. Fig.~\ref{fig:ar_screenshot} shows a real failure case where a
tablet is classified as a phone, yet the wireframe box is still drawn
correctly around the object. This confirms that the rendering pipeline is
robust regardless of whether the classification itself is right.
