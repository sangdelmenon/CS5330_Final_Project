...
Training from scratch worked well for the CNN on the clean 5-class webcam
dataset, reaching near-perfect accuracy, but performance dropped noticeably
on the noisier 10-class data. The ViT was the slowest to converge and would
benefit from a larger dataset.

The biggest source of error in the 10-class model was the quality of the
web-downloaded images rather than any weakness in the architecture. Glasses
was the hardest class because the Bing crawl returned a mix of eyeglasses
and drinking glasses under the same label. Tablet and phone were frequently
confused because both are flat rectangles and look almost identical at
certain angles. Collecting dedicated webcam images for those five web-only
classes under controlled conditions would likely close most of that gap.
